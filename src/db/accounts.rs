...
impl AccountRow {
    ...
    pub fn get_address(&self, network: Network, password: &Zeroizing<String>) -> WalletDbResult<TariAddress> {
    ...
    pub fn get_key_manager(&self, password: &Zeroizing<String>) -> WalletDbResult<KeyManager> {
        let (view_key, spend_key) = self.decrypt_keys(password)?;
